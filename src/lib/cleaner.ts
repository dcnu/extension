 ...
 */
async function cleanDomainData(domain: string): Promise<void> {
 ...
 */
export async function isCleanOnCloseDomain(hostname: string): Promise<string | null> {
 ...
 */
export async function cleanAndLog(domain: string): Promise<void> {
	const aliases = await getDomainAliases();
